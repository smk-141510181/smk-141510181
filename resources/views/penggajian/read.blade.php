            ...
            <div class="panel panel-default">
                ...
                <div class="">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <h3>{{$datapenggajian->PegawaiTunjangan->Pegawai->User->name}}</h3>
                        <h4>{{$datapenggajian->PegawaiTunjangan->Pegawai->nip}}</h4>
                        ...
                        @endif</b>
                        <h5>Gaji Lembur Sebesar Rp.{{$datapenggajian->jumlah_uang_lembur}} ,Gaji Pokok Sebesar Rp.{{$datapenggajian->gaji_pokok}} ,Mendapat Tunjangan Sebesar Rp.{{$datapenggajian->PegawaiTunjangan->tunjangan->besaran_uang}} ,Jadi Total Gaji Rp.{{$datapenggajian->gaji_total}}
