...
<h3>Data Tunjangan Pegawai</h3>

<a class="btn btn-primary" href="<?php echo e(route('tunjanganpegawai.create')); ?>">Buat Data Tunjangan Pegawai</a>
<br><br>
		...
		<tr>
			...
			<td><?php echo e($a->Pegawai->User->name); ?></td>			
				<td>
					...
					<a href="<?php echo e(route('tunjanganpegawai.edit',$a->id)); ?>" type="submit" button type="button" class="btn btn-warning">Edit</a>
