...
<a href="<?php echo e(route('golongan.create')); ?>"><button class="btn btn-flat"> Buat Data Golongan</a></button>
<br><br>
		...
		<tr>
			...
			<td><?php echo e($a->besar_uang); ?></td>			
				<td>
					...
					<a href="<?php echo e(route('golongan.edit',$a->id)); ?>" type="submit" button type="button" class="btn-flat yellow">Edit</a>
